Pod::Spec.new do |s|
  ...
  s.screenshots  = "https://github.com/DominatorVbN/SlideUpPanel/blob/master/SlideUpPanel.gif"
  s.license      = "MIT"
  s.author             = { "DominatorVbN" => "as9039851921@gmail.com" }
  s.platform     = :ios, "12.0"
  s.source       = { :git => "https://github.com/DominatorVbN/SlideUpPanel.git", :tag => "1.0.4" }
